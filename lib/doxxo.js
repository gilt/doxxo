...
module.exports = function doxxo (options) {
  ...
  options = _.extend({
      ...
      behavior: options.behavior || 'http://cdn.rawgit.com/gilt/doxxo/master/static/behavior.js',
      css: {
        style: options.style || 'http://cdn.rawgit.com/gilt/doxxo/master/static/doxxo.css',
        syntax: options.syntax || 'http://cdn.rawgit.com/isagalaev/highlight.js/master/src/styles/monokai.css'
      }
    },
    options);
